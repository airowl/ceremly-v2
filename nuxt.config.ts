...
export default defineNuxtConfig({
    ...
    routeRules: {
        ...
        "/come-funziona": { prerender: true },
        "/en/come-funziona": { prerender: true },
        "/funzionalita": { prerender: true },
        "/en/funzionalita": { prerender: true },
        "/modelli": { prerender: true },
        "/en/modelli": { prerender: true },
        "/prezzi": { prerender: true },
        "/en/prezzi": { prerender: true },
        "/esempi": { prerender: true },
        "/en/esempi": { prerender: true },
        "/matrimoni": { prerender: true },
        "/en/matrimoni": { prerender: true },
        "/lauree": { prerender: true },
        "/en/lauree": { prerender: true },
        "/battesimi": { prerender: true },
        "/en/battesimi": { prerender: true },
        "/compleanni": { prerender: true },
        "/en/compleanni": { prerender: true },
        "/wedding-planner": { prerender: true },
        "/en/wedding-planner": { prerender: true },
        "/guida-rsvp": { prerender: true },
        "/en/guida-rsvp": { prerender: true },
        "/centro-aiuto": { prerender: true },
        "/en/centro-aiuto": { prerender: true },
        "/stato": { prerender: true },
        "/en/stato": { prerender: true },
