<template>
    <UContainer class="py-24 sm:py-32">
        <div class="text-center mb-16 sm:mb-20">
            <!-- Section Header -->
            <div ref="headerRef" class="transition-all duration-1000 ease-out"
        ...
        <div ref="missionRef" class="max-w-4xl mx-auto transition-all duration-1000 ease-out"
            ...
            <UCard
                ...
                <div class="text-center py-8">
                    <UBadge :label="$t('landing.why.mission.badge')" color="primary" variant="solid" size="md"
