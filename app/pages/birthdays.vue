...
// Sito pubblico → Per chi → Compleanni. Pagina sottile: SEO + corpo condiviso.
...
const seoTitle = t('ceremly.site.usecases.compleanni.seoTitle')
const seoDescription = t('ceremly.site.usecases.compleanni.seoDescription')
useSeoMeta({
    title: seoTitle,
