...
- **Task 17–18:** non avviati. Runtime, dati applicativi di dominio, billing e le restanti superfici frontend restano su Neon/Drizzle; la configurazione locale usa `NUXT_NITRO_PRESET=node-server`.
