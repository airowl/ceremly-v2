...
const translations = {
    it: {
        preview: 'Benvenuto nella Waiting List di Ceremly!',
        title: 'Benvenuto nella Waiting List di Ceremly!',
        greeting: 'Gentile utente,',
        intro: 'Grazie per il tuo interesse in Ceremly, la piattaforma SaaS completa per la gestione degli eventi.',
        successTitle: 'La tua email è stata registrata con successo!',
        successText: 'Riceverai una notifica non appena la piattaforma sarà disponibile. Sarai tra i primi ad accedere a tutte le funzionalità innovative di Ceremly.',
        ...
        footer: 'Hai ricevuto questa email perché ti sei iscritto alla waiting list di Ceremly.',
        address: 'Ceremly - Via Example 123, 00100 Roma, Italia',
    },
    en: {
        preview: "Welcome to Ceremly's Waiting List!",
        title: "Welcome to Ceremly's Waiting List!",
        greeting: 'Dear User,',
        intro: 'Thank you for your interest in Ceremly, the complete SaaS platform for event management.',
        successTitle: 'Your email has been successfully registered!',
        successText: "You will receive a notification as soon as the platform is available. You'll be among the first to access all of Ceremly's innovative features.",
        ...
        footer: "You received this email because you signed up for Ceremly's waiting list.",
