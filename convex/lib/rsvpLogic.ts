 ...
 * - backend Convex (`convex/rsvp.ts`): validazione autoritativa della submission.
 *
 * Task 11: il modulo vive qui e `shared/utils/rsvpLogic.ts` lo riesporta. La
 * validazione autoritativa deve girare **dentro** la mutation che scrive la
 * risposta: un mirror avrebbe significato due implementazioni della stessa regola
 * di sicurezza (§8.4, nessuna answer injection), che è il modo più rapido per farle
 * divergere.
 */
import type {
  AttendingStatus,
