 ...
 */
// Type-only import from outside `convex/` (erased at bundle time). The module
// moved here in Task 11 so the presets Convex deep-clones at event creation are
// the same ones the editor UI applies; `shared/constants/rsvpPresets.ts`
// re-exports it for the client.
import type { EventTypeKey, RsvpCondition, RsvpQuestion } from "../../shared/types/ceremly";
